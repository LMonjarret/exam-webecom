...
// Template de type page, affiche le formulaire de modification d'une fiche
...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <form enctype="multipart/form-data" action="index.php?module=fiche&action=update&id=<?= $this->getId() ?>" method="POST" class="form-fiche">
